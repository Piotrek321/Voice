...
(cl:ensure-generic-function 'some_strings-val :lambda-list '(m))
(cl:defmethod some_strings-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-msg:some_strings-val is deprecated.  Use beginner_tutorials-msg:some_strings instead.")
  (some_strings m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Num>) ostream)
  "Serializes a message object of type '<Num>"
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'some_strings))))
  ...
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) ele))
   (cl:slot-value msg 'some_strings))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Num>) istream)
  ...
  (cl:setf (cl:slot-value msg 'some_strings) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'some_strings)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Num>)))
  ...
  "80483ddcea4b6752b8ef7f4c8d4fe7d2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Num)))
  "Returns md5sum for a message object of type 'Num"
  "80483ddcea4b6752b8ef7f4c8d4fe7d2")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Num>)))
  ...
  (cl:format cl:nil "~%string[] some_strings~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Num)))
  "Returns full string definition for message of type 'Num"
  (cl:format cl:nil "~%string[] some_strings~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Num>))
  (cl:+ 0
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'some_strings) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4 (cl:length ele))))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Num>))
  "Converts a ROS message object to a list"
  (cl:list 'Num
    (cl:cons ':some_strings (some_strings msg))
))
